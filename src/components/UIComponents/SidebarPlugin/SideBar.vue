<template>
  ...
  >
    <div class="logo">
      <a class="simple-text logo-mini" aria-label="sidebar mini logo" href="/#/admin/overview">
        <div class="logo-img">
          <img :src="logo" alt="" />
        </div>
      </a>
      <a class="simple-text logo-normal appName" href="/#/admin/overview">
        {{ title }}
      </a>
    </div>
...
export default {
  props: {
    ...
    logo: {
      type: String,
      default: "static/img/apartment.png",
